...
namespace QM.Core.Files
{
    ...
    public class QMFtp
    {
        ...
        public QMFtp(string server, string user, string pass)
        {
            this.server = server;
            this.user = user;
            this.pass = pass;
        ...
        /// <param name="user">登陆帐号</param>
        /// <param name="pass">登陆口令</param>
        public QMFtp(string server, int port, string user, string pass)
        {
            this.server = server;
            this.user = user;
            this.pass = pass;
        ...
        public QMFtp(string server, int port, string user, string pass, int mode)
        {
            this.server = server;
            this.user = user;
            this.pass = pass;
        ...
        public QMFtp(string server, int port, string user, string pass, int mode, int timeout_sec)
        {
            this.server = server;
            this.user = user;
            this.pass = pass;
