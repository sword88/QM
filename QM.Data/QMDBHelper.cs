...
namespace QM.Data
{
    ...
    {
        private static string DbConStr;
        ...
        /// <param name="commandParameters">an array of SqlParamters used to execute the command</param>
        /// <returns>a OleDbDataReader containing the resultset generated by the command</returns>
        public static OleDbDataReader ExecuteReader(string _connnectionstring, string commandText,
                                                    params OleDbParameter[] commandParameters)
        {
            //create OleDbConnection
        ...
        public static OleDbDataReader ExecuteReader(string commandText, CommandType type, params OleDbParameter[] commandParameters)
        {
            //create OleDbConnection
            OleDbConnection cn = new OleDbConnection(DbConStr);
            //cn.Open();
        ...
        /// <param name="commandParameters">an array of SqlParamters used to execute the command</param>
        /// <returns>a OleDbDataReader containing the resultset generated by the command</returns>
        public static OleDbDataReader ExecuteReaderofBinary(string commandText,
                                                            params OleDbParameter[] commandParameters)
        {
            //create OleDbConnection
            OleDbConnection cn = new OleDbConnection(DbConStr);
        ...
        public static DataSet ExecuteDataset(string _ConnectionString, string commandText)
        {
            //create OleDbConnection
        ...
        /// <param name="commandText">SQL command</param>
        /// <returns>a dataset containing the resultset generated by the command</returns>
        public static DataSet ExecuteDatasetofBinary(string commandText)
        {
            //pass through the call providing null for the set of OleDbParameters
        ...
        /// <param name="commandParameters">an array of OleDbParamters used to execute the command</param>
        /// <returns>a dataset containing the resultset generated by the command</returns>
        public static DataSet ExecuteDatasetofBinary(string commandText, params OleDbParameter[] commandParameters)
        {
            //create OleDbConnection
            OleDbConnection cn = new OleDbConnection(DbConStr);
        ...
        public static int ExecuteNonQuery(string commandText, CommandType commandType, OleDbCommand cmd, params OleDbParameter[] commandParameters)
        {
            //create OleDbConnection
            OleDbConnection cn = new OleDbConnection(DbConStr);
        ...
        // 저장 프로시져 호출 하기 위한 ExecuteNonQuery 추가 by ythong
        public static int ExecuteNonQuery(string _connectionString, string commandText, params OleDbParameter[] commandParameters)
        {
            //create OleDbConnection
            OleDbConnection cn = new OleDbConnection(DbConStr);
            OleDbCommand cmd = new OleDbCommand();
        ...
        public static int ExecuteNonQuery(OleDbConnection cn, string commandText, CommandType commandType, params OleDbParameter[] commandParameters)
        {
            //create a command and prepare it for execution
            OleDbCommand cmd = new OleDbCommand();
            PrepareCommand(cmd, cn, commandType, commandText, commandParameters);
